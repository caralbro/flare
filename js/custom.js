...
function submitForm(){
    ...
    $.ajax({
        ...
        data: "nname=" + name + "&email=" + email + "&phone=" + phone,
...
$(document).ready(function(){$(".ss-icon").on("click",function(t){t.preventDefault(),$(".style-switcher").toggleClass("show"),$(this).toggleClass("rotating")}),$(".colors-skins li button").on("click",function(){$(".colors-skins li button").removeClass("active"),$(this).addClass("active")}),$(".colors-skins li button").each(function(){$(this).on("click",function(){$("[data-color-skins]").attr("href","css/skins/"+$(this).attr("value")+".css")})}),$(".switch-button").each(function(){$(this).on("click",function(){$(this).toggleClass("active"),$(this).next().toggleClass("active"),$(this).prev().toggleClass("active")})}),$(".logo-option .switch-button").on("click",function(){$(".logo").toggleClass("image-logo text-logo")}),$(".header-tc-option").on("click",function(){$(".header-top-content").toggleClass("hide")}),$(".logo-and-nav-option").on("click",function(){$(".logo-and-nav").toggleClass("hide")})});
